<div class="footer">
    <footer class="text-dark">
        <div class="container py-4">
            ...
            <div class="row justify-content-center mb-3">
                <div class="col-auto">
                    <span class="badge bg-dark fs-5 px-3 py-2">0254531</span>
                </div>
            </div>
            <div class="row justify-content-center text-center">
                <div class="col-12">
                    <h4 class="mb-1">LEGEND WALKER 全台獨家代理</h4>
                    <p class="mb-1">歐印精品 all-en Boutique 電話 04-2291-4216 郵件 info@all-en.com.tw</p>
                    <p class="mb-0">Copyright 2011 all-en Taiwan Ltd. All rights reserved</p>
                </div>
            </div>
        </div>
    </footer>
